...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.ohgiraffers.section.aop.*Service.*(..))")
    public void LoggingAspect() {
    }

    //    @Before("execution(* com.ohgiraffers.section.aop.*Service.*(..))")
    ...
    /* 설명. returning에 쓰인 이름이 반환값이 넘어올 때의 이름이고 매개변수와 일치채야 한다.(result)*/
    ...
    *   타겟 메소드를 언제 실행하지, 아니면 아예 실행을 안할지 여부도 제어한다.(필터와 유사함)
